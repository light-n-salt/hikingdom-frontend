...
function ClubMountain() {
  return (
    ...
    >
      ...
      <Cube position={new THREE.Vector3(-1, 0, 0)} url='https://lightnsalt.s3.ap-northeast-2.amazonaws.com/asset/main5.gltf'/>
      {/* <Cube position={new THREE.Vector3(2, 0, 0)} url='https://lightnsalt.s3.ap-northeast-2.amazonaws.com/asset/main5.gltf'/> */}
      {/* <Cube position={new THREE.Vector3(2, 0, 3)} url='https://lightnsalt.s3.ap-northeast-2.amazonaws.com/asset/main5.gltf'/> */}
