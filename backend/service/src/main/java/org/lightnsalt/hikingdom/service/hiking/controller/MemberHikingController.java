...
public class MemberHikingController {
	...
	@GetMapping("")
	public ResponseEntity<CustomResponseBody> hikingRecordList(Authentication authentication,
		@RequestParam(defaultValue = "") Long hikingRecordId, Pageable pageable) {

		CustomSlice<HikingRecordListRes> result = memberHikingService.findHikingRecordList(authentication.getName(),
