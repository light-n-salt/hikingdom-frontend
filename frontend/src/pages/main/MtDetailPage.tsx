...
const mtInfo: MtInfoDetail = {
    ...
    maxAlt: 608,
    address: "경기 과천시 중앙동",
    imgUrl: "https://img1.daumcdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/8sX5/image/u8B0YI9f8TCYpaL_b4Q4_DTujco.jpg",
    timeDuration: 180,
    peaks: ["연주대"],
    description: "관악산은 예로부터 정기가 흘러, 반만년 역사 깊은 한양 성터에 찬란히 빛나도다 우리학교는. 이 강산 축복받은 배움집이요 지인용 연마하여 자라는도다. 해달이 무궁토록 하리라. 관악산은 예로부터 정기가 흘러, 반만년 역사 깊은 한양 성터에 찬란히 빛나도다 우리학교는. 이 강산 축복받은 배움집이요 지인용 연마하여 자라는도다.",
